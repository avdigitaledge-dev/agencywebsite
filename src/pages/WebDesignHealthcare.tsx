        ...
        <div className="container-tight">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {healthcareTypes.map((type) => (
              <motion.div key={type.title} className="bg-card rounded-xl p-6 border border-border shadow-card" {...fadeUp}>
        ...
        <div className="container-tight">
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-3xl mx-auto">
            {[
              ...
              <motion.div key={f.title} className="flex gap-4 p-5 bg-card rounded-xl border border-border shadow-card" {...fadeUp}>
      ...
      <section className="section-padding bg-background">
        <div className="container-tight max-w-3xl mx-auto">
          <motion.div className="text-center mb-10" {...fadeUp}>
            <h2 className="heading-section text-foreground mb-4">Healthcare Website FAQs</h2>
          </motion.div>
