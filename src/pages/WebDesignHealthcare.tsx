        ...
        <div className="container-tight">
          ...
          <ScrollReveal className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {healthcareTypes.map((type) => (
              <motion.div key={type.title} variants={fadeUp} className="bg-card rounded-xl p-6 border border-border shadow-card card-hover-lift">
        ...
        <div className="container-tight">
          ...
          <ScrollReveal className="grid md:grid-cols-2 gap-6 max-w-3xl mx-auto">
            {[
              ...
              <motion.div key={f.title} variants={fadeUp} className="flex gap-4 p-5 bg-card rounded-xl border border-border shadow-card card-hover-lift">
      ...
      <section className="section-padding bg-background">
        <div className="container-tight max-w-3xl mx-auto">
          <ScrollReveal className="text-center mb-10">
            <motion.h2 variants={fadeUp} className="heading-section text-foreground mb-4">Healthcare Website FAQs</motion.h2>
          </ScrollReveal>
        ...
        <div className="container-tight px-4 py-20 text-center relative z-10">
          <ScrollReveal>
            ...
            <motion.div variants={fadeUp}>
              <Button variant="hero" size="lg" asChild>
                <Link to="/contact">Get Your Free Healthcare Website Quote <ArrowRight className="w-5 h-5 ml-1" /></Link>
              </Button>
            </motion.div>
          </ScrollReveal>
        </div>
