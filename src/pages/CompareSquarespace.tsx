...
const comparisonRows = [
  { factor: "Monthly Cost", us: "From $995 one-off + $99/mo", them: "$16–$49/mo" },
...
const CompareSquarespace = () => {
  ...
  return (
    <Layout>
      <SEOMeta
        title="Professional Web Design vs Squarespace | Digital Edge Studio"
        ...
        canonical="https://digitaledgestudio.com/vs/squarespace"
        keywords="squarespace vs professional web design, squarespace alternative australia, custom website vs squarespace, squarespace seo limitations, web designer vs squarespace"
        ogTitle="Professional Web Design vs Squarespace | Digital Edge Studio"
        ogDescription="Squarespace looks great but can it generate leads? See the full comparison."
        faqSchema={faqSchema}
      />
