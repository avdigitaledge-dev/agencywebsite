  ...
  const faqSchema = {
    ...
    "mainEntity": [
      ...
      },
      {
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Our Illawarra web design packages start from $800 for a Starter Website. We offer transparent, fixed pricing with no hidden fees. Get a free quote to discuss your project."
        }
      }
    ]
  };
      ...
      <section className="section-padding bg-background">
        <div className="container-tight">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {areas.map((area) => (
              <motion.div key={area.name} className="bg-card rounded-xl p-6 border border-border shadow-card" {...fadeUp}>
        ...
        <div className="container-tight">
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-3xl mx-auto">
            {[
              ...
              <motion.div key={s.title} className="flex gap-4 p-6 bg-card rounded-xl border border-border shadow-card" {...fadeUp}>
