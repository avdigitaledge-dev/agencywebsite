...
const CompareWix = () => {
  ...
  return (
    <Layout>
      <SEOMeta
        title="Professional Web Design vs Wix | Digital Edge Studio"
        ...
        canonical="https://digitaledgestudio.com/vs/wix"
        keywords="wix vs professional web design, wix alternative australia, custom website vs wix, web designer vs wix, wix seo problems"
        ogTitle="Professional Web Design vs Wix | Digital Edge Studio"
        ogDescription="Wix is great for hobbies, but your business deserves better. See the full comparison."
        faqSchema={faqSchema}
      />
