...
const AeoGeoServices = () => {
  ...
  return (
    <Layout>
      <SEOMeta
        title="AEO & GEO Services — AI Search Optimisation | Digital Edge Studio"
        description="Get found by AI search with Answer Engine Optimisation (AEO) and Generative Engine Optimisation (GEO). We optimise your website for Google AI Overviews, ChatGPT, Siri, and voice search. Wollongong & Sydney."
        keywords="aeo, geo, answer engine optimisation, generative engine optimisation, ai search optimisation, ai seo, google ai overviews, voice search optimisation, chatgpt optimisation, wollongong seo, sydney seo"
        canonical="https://digitaledgestudio.com/services/aeo-geo"
        ogTitle="AEO & GEO Services — AI Search Optimisation | Digital Edge Studio"
        ogDescription="Get found by AI search. We optimise your website for Google AI Overviews, ChatGPT, Siri, and voice search. Included in our Local SEO package."
          ...
          >
            ...
            <motion.div variants={fadeUp} className="flex flex-col sm:flex-row gap-4">
              <Button variant="hero" size="lg" asChild>
                <Link to="/contact">Get Started <ArrowRight className="w-5 h-5 ml-1" /></Link>
              </Button>
          ...
          <ScrollReveal className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              >
                ...
                <Link to={item.link} className="text-accent text-sm font-semibold hover:text-accent/80 transition-colors inline-flex items-center gap-1">
        ...
        <div className="container-tight px-4 py-20 text-center relative z-10">
          <ScrollReveal>
            ...
            <motion.div variants={fadeUp} className="flex flex-col sm:flex-row justify-center gap-4">
              <Button variant="hero" size="lg" asChild>
                <Link to="/pricing">See Pricing <ArrowRight className="w-5 h-5 ml-1" /></Link>
              </Button>
              <Button variant="hero-outline" size="lg" asChild>
