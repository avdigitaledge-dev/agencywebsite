...
import { ArrowRight, CheckCircle2, Wrench, Star, Zap } from "lucide-react";
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      ...
      },
      {
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Our tradie website packages start from $1,200. We keep it simple and reliable so tradies can get a professional website without breaking the bank."
        }
      },
      {
        "@type": "Question",
              ...
              <div className="relative flex flex-col md:flex-row md:items-center gap-6">
                ...
                <div className="flex-1">
                  ...
                  <h3 className="font-display font-bold text-xl md:text-2xl text-foreground mb-2">
                    AI Lead Response Engine for Tradies
                  </h3>
