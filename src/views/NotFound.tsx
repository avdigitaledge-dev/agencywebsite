...
const suggestedPages = [
  ...
  { icon: Star, label: "Our Work", description: "Case studies & results", href: "/portfolio" },
  { icon: Search, label: "Free Website Review", description: "Get a free site audit", href: "/free-website-review" },
  { icon: FileText, label: "Blog", description: "Tips & guides", href: "/blog" },
  { icon: DollarSign, label: "Pricing", description: "Transparent packages", href: "/pricing" },
];
          ...
          >
            ...
            <motion.div variants={fadeUp} className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button variant="hero" size="lg" asChild>
                <Link href="/">Back to Home <ArrowRight className="w-5 h-5 ml-1" /></Link>
              </Button>
