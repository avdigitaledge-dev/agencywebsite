...
const comparisonRows = [
  { factor: "Monthly Cost", us: "From $1,200 one-off + $99/mo", them: "$12–$25/mo + upsells" },
  { factor: "Custom Design", us: "100% custom, conversion-focused", them: "Limited templates, cookie-cutter look" },
  { factor: "Local SEO", us: "Built-in, optimised for your area", them: "Basic SEO tools, limited control" },
  { factor: "AEO & GEO", us: "Included", them: "Not available" },
  { factor: "Page Speed", us: "Optimised for Core Web Vitals", them: "Shared hosting, often slow" },
  { factor: "Mobile Performance", us: "Mobile-first design", them: "Responsive but not optimised" },
  { factor: "Ongoing Support", us: "Dedicated support & updates", them: "Ticket-based, slow response" },
  { factor: "Ownership", us: "You own everything", them: "Locked to GoDaddy platform" },
  { factor: "Upselling", us: "Transparent pricing, no surprises", them: "Constant upsells for add-ons" },
];

const faqs = [
  {
    question: "Is GoDaddy good for small business websites?",
    answer: "GoDaddy is fine for getting something online quickly but their builder produces generic sites with limited SEO capability. For businesses that need leads from Google, it's not enough.",
  },
  {
    question: "Why are GoDaddy websites so slow?",
    answer: "GoDaddy uses shared hosting by default, meaning your site shares resources with thousands of others. Combined with their template code, this leads to poor load times that hurt both user experience and Google rankings.",
  },
  {
    question: "Can I move my site from GoDaddy?",
    answer: "Yes. We can migrate your content from GoDaddy to a professionally built website. We handle the full migration including DNS, email, and SEO redirects.",
  },
  {
    question: "Is GoDaddy cheaper than hiring a web designer?",
    answer: "Monthly, yes. But GoDaddy constantly pushes paid add-ons (SSL, email, SEO tools, premium templates) that add up. A professional website is a one-time investment that generates measurable returns through better SEO and conversion rates.",
  },
];

const CompareGodaddy = () => {
  return (
    <>
        ...
        <div className="container-tight px-4 py-16 md:py-24 relative z-10">
          <motion.div className="max-w-3xl" initial="hidden" animate="show" variants={staggerC}>
            <motion.h1 variants={fadeUpC} className="heading-display text-primary-foreground mb-4">
              Professional Web Design vs GoDaddy — <span className="text-gradient">Which Is Right for Your Business?</span>
            </motion.h1>
              ...
              <table className="w-full border-collapse">
                <thead>
                  <tr>
                    ...
                    <th className="text-left p-4 text-sm font-semibold text-muted-foreground uppercase tracking-wider border-b border-border">GoDaddy</th>
                  </tr>
                </thead>
                <tbody>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <ScrollReveal variant="C">
              <motion.div variants={fadeUpC} className="bg-card rounded-2xl border border-border shadow-card p-8 h-full">
                <h2 className="heading-section text-foreground mb-6">When GoDaddy Makes Sense</h2>
      ...
      {/* ═══ FAQ ═══ */}
      <FAQ faqs={faqs} title="GoDaddy vs Professional Web Design — FAQ" />
    </>
  );
};

export default CompareGodaddy;
