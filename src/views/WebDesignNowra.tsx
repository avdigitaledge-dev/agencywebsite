...
const WebDesignNowra = () => {
  const localBusinessSchema = {
    ...
    "description": "Web design agency serving Nowra and the Shoalhaven region, specialising in affordable websites and local SEO for small businesses",
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "Do you offer web design services in Nowra?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Yes — Digital Edge Studio is based in Wollongong, about 45 minutes north of Nowra, and we regularly serve businesses across Nowra and the wider Shoalhaven region with professional web design and local SEO."
        }
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        "name": "Can you do local SEO for the Shoalhaven area?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Yes — we optimise your website and Google Business Profile for Nowra and Shoalhaven-specific search terms, helping you rank higher in local Google Maps results and organic search."
        }
      },
      {
        "@type": "Question",
        "name": "Do you meet with clients in Nowra?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Yes — we're available for in-person meetings in Nowra and the Shoalhaven area. We also offer video calls for convenience, so you can choose whichever works best for you."
        }
      },
      {
        "@type": "Question",
  ...
  const services = [
    { title: "Custom Website Design", desc: "Professionally designed websites built to convert visitors into enquiries for your Nowra or Shoalhaven business." },
    { title: "Local SEO Nowra & Shoalhaven", desc: "Rank higher in Google Maps and organic search for Nowra and Shoalhaven-specific keywords that drive real leads." },
    { title: "Mobile-Optimised Websites", desc: "Over 70% of local searches happen on mobile. Your Nowra website will look perfect on every device." },
    { title: "Google Ads Management", desc: "Targeted Google Ads campaigns for Nowra and Shoalhaven businesses — only pay when someone clicks to your site." },
    { title: "Ecommerce Web Design", desc: "Online stores built on Shopify or WooCommerce to sell products to Nowra, the Shoalhaven, and beyond." },
    { title: "Website Maintenance", desc: "Monthly plans to keep your Nowra website fast, secure, and up to date. From $99/month." },
  ];
        ...
        <div className="container-tight px-4 py-16 md:py-24 relative z-10">
          ...
          >
            <motion.div variants={fadeUpB} className="flex items-center gap-2 text-primary-foreground/70 text-sm mb-4">
              ...
              <span>Serving Nowra, Shoalhaven & South Coast</span>
            </motion.div>
            ...
            <motion.p variants={fadeUpB} className="text-body-lg text-primary-foreground/75 max-w-2xl mb-8">
              Professional web design for Nowra and Shoalhaven businesses. Digital Edge Studio is based in nearby Wollongong, serving the South Coast with websites that rank on Google, generate leads, and grow your business.
            </motion.p>
          ...
          <ScrollReveal variant="B" className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div variants={fadeUpB}>
              <h2 className="heading-section text-foreground mb-6">
                Why Choose a Nearby Web Designer for Your Nowra Business?
              </h2>
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                <p>
                  When you hire a nearby web designer for your Nowra business, you're getting a partner who understands the Shoalhaven region — from Nowra CBD and Bomaderry to Berry, Shoalhaven Heads, and South Nowra.
                </p>
                <p>
                  Nowra has a growing business community and a thriving tourism industry. We understand the local competition and the kinds of searches your customers make when they need a business like yours on the South Coast.
                </p>
                <p>
            ...
            <motion.div variants={fadeUpB} className="space-y-4">
              {[
                { title: "South Coast Market Knowledge", desc: "We understand Nowra's business landscape and what local customers across the Shoalhaven search for." },
                { title: "Shoalhaven SEO Expertise", desc: "We optimise specifically for Nowra and Shoalhaven search terms, not generic keywords." },
                { title: "Personal Service", desc: "We're available for meetings in Nowra and video calls — you always deal directly with the person running your project." },
        ...
        <div className="container-tight">
          <ScrollReveal variant="B" className="grid md:grid-cols-2 gap-8">
            <motion.div variants={fadeUpB} className="bg-card rounded-xl p-8 border border-border shadow-card card-hover-lift">
              ...
              <p className="text-sm text-muted-foreground mb-6">Perfect for tradies and service businesses in Nowra getting started online</p>
            ...
            <motion.div variants={fadeUpB} className="bg-card rounded-xl p-8 border-2 border-accent shadow-card card-hover-lift">
              ...
              <p className="text-sm text-muted-foreground mb-6">Full-featured site for established Nowra businesses ready to grow</p>
              <ul className="space-y-2 mb-6">
            ...
            <motion.div variants={fadeUpB}>
              <Link href="/web-design-south-coast" className="group flex gap-4 p-6 bg-card rounded-xl border border-border shadow-card card-hover-lift">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Affordable web design for businesses across the NSW South Coast — Ulladulla, Batemans Bay, Sussex Inlet & more.</p>
            ...
            <motion.div variants={fadeUpB}>
              <Link href="/web-design-shellharbour" className="group flex gap-4 p-6 bg-card rounded-xl border border-border shadow-card card-hover-lift">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Professional web design and local SEO for Shellharbour businesses — helping you stand out online.</p>
                  <span className="text-sm text-accent font-medium mt-2 inline-flex items-center gap-1">Learn more <ArrowRight className="w-3 h-3" /></span>
                </div>
              </Link>
            </motion.div>
            <motion.div variants={fadeUpB}>
              <Link href="/web-design-wollongong" className="group flex gap-4 p-6 bg-card rounded-xl border border-border shadow-card card-hover-lift">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Our home base — expert web design and SEO for Wollongong and the Illawarra region.</p>
                  <span className="text-sm text-accent font-medium mt-2 inline-flex items-center gap-1">Learn more <ArrowRight className="w-3 h-3" /></span>
                </div>
              </Link>
            </motion.div>
            <motion.div variants={fadeUpB}>
              <Link href="/web-design-kiama" className="group flex gap-4 p-6 bg-card rounded-xl border border-border shadow-card card-hover-lift">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Website design and local SEO for Kiama businesses — tourism, retail, trades & professional services.</p>
                  <span className="text-sm text-accent font-medium mt-2 inline-flex items-center gap-1">Learn more <ArrowRight className="w-3 h-3" /></span>
                </div>
              </Link>
            </motion.div>
        ...
        <div className="container-tight px-4 py-20 text-center relative z-10">
          <ScrollReveal variant="B">
            ...
            <motion.p variants={fadeUpB} className="text-body-lg text-primary-foreground/75 max-w-2xl mx-auto mb-8">
              Get a free, no-obligation quote for your Nowra website. We'll discuss your goals and recommend the best solution for your business.
            </motion.p>
