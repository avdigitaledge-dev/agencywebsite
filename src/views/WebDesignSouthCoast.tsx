...
const WebDesignSouthCoast = () => {
  const faqSchema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "Do you serve the South Coast of NSW?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Yes — we serve businesses right across the NSW South Coast, including Nowra, Berry, Huskisson, Jervis Bay, Ulladulla, Milton, and Batemans Bay. We understand the local market and build websites designed to attract customers in your area."
        }
      },
      {
        "@type": "Question",
        "name": "How much does a website cost for a South Coast business?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Our South Coast web design packages start from $1,200 for a Starter Website and $1,850 for a full Business Website. We offer transparent pricing with no hidden fees or lock-in contracts."
        }
      },
      {
        "@type": "Question",
        "name": "Can you help a tourism business on the South Coast?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Yes — we have experience working with tourism and hospitality businesses on the South Coast. Whether you run accommodation, tours, a restaurant, or an activity provider, we build websites that showcase your offerings and drive bookings."
        }
      },
      {
        "@type": "Question",
        "name": "Do you do local SEO for the Shoalhaven region?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Yes — local SEO is one of our specialties. We target South Coast and Shoalhaven-specific search terms, optimise your Google Business Profile, and help you rank higher in local Google Maps results so customers in your area can find you."
        }
      },
      {
        "@type": "Question",
        "name": "Do you meet with South Coast clients in person?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Yes — we're available for in-person meetings with South Coast clients, or we can work together via video call. Whatever suits you best, we're flexible and happy to accommodate."
        }
      }
    ]
  };
  ...
  const services = [
    { title: "Custom Website Design", desc: "Professionally designed websites built to convert visitors into enquiries — tailored for South Coast businesses." },
    { title: "Local SEO South Coast", desc: "Rank higher in Google Maps and organic search for South Coast and Shoalhaven-specific keywords that drive real leads." },
    { title: "Mobile-Optimised Websites", desc: "Over 70% of local searches happen on mobile. Your South Coast website will look perfect on every device." },
    { title: "Google Ads Management", desc: "Targeted Google Ads campaigns for South Coast businesses — only pay when someone clicks to your site." },
    { title: "Ecommerce Web Design", desc: "Online stores built on Shopify or WooCommerce to sell products to the South Coast and beyond." },
    { title: "Website Maintenance", desc: "Monthly plans to keep your South Coast website fast, secure, and up to date. From $99/month." },
  ];
        ...
        <div className="container-tight px-4 py-16 md:py-24 relative z-10">
          ...
          >
            <motion.div variants={fadeUpB} className="flex items-center gap-2 text-primary-foreground/70 text-sm mb-4">
              ...
              <span>Serving the NSW South Coast</span>
            </motion.div>
      ...
      <section className="bg-muted py-8">
        <div className="container-tight px-4">
          <div className="flex flex-wrap justify-center gap-8 text-sm text-muted-foreground">
            {["Serving the Entire South Coast", "No Lock-In Contracts", "Fast 4\u20138 Week Turnaround", "Free Quote & Consultation", "Google Business Profile Setup Included"].map((item) => (
        ...
        <div className="container-tight">
          <ScrollReveal variant="B" className="text-center mb-14">
            <motion.h2 variants={fadeUpB} className="heading-section text-foreground mb-4">
              Web Design Services for the South Coast
            </motion.h2>
            <motion.p variants={fadeUpB} className="text-body-lg text-muted-foreground max-w-2xl mx-auto">
              Everything your South Coast business needs to get found online and turn website visitors into paying customers.
            </motion.p>
          </ScrollReveal>
          ...
          <ScrollReveal variant="B" className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div variants={fadeUpB}>
              <h2 className="heading-section text-foreground mb-6">
                Why Choose Digital Edge Studio for Your South Coast Website?
              </h2>
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                <p>
                  The NSW South Coast is home to a thriving mix of tourism, hospitality, trades, and local services — from Nowra and Berry to Huskisson, Jervis Bay, Ulladulla, Milton, and Batemans Bay. We understand what it takes to stand out in this unique market.
                </p>
                <p>
                  With a strong tourism and hospitality industry driving the region, your website needs to do more than just exist — it needs to attract visitors, showcase your offerings, and convert browsers into bookings and enquiries.
                </p>
                <p>
                  Unlike large agencies or offshore developers, you get personal service and a partner who genuinely cares about helping your South Coast business grow online.
                </p>
              </div>
              <div className="mt-8">
                <Button asChild>
                  <Link href="/contact">Talk to Us About Your South Coast Website <ArrowRight className="w-4 h-4 ml-1" /></Link>
                </Button>
              </div>
            </motion.div>
            <motion.div variants={fadeUpB} className="space-y-4">
              {[
                { title: "South Coast Market Knowledge", desc: "We understand the South Coast business landscape, from Shoalhaven to the Eurobodalla, and what local customers search for." },
                { title: "Tourism & Hospitality Expertise", desc: "Experience building websites for accommodation, tours, restaurants, and activity providers across the South Coast." },
                { title: "Personal Service", desc: "You deal directly with the person building your website — no account managers or outsourced teams." },
        ...
        <div className="container-tight">
          <ScrollReveal variant="B" className="grid md:grid-cols-2 gap-8">
            ...
            <motion.div variants={fadeUpB} className="bg-card rounded-xl p-8 border-2 border-accent shadow-card card-hover-lift">
              ...
              <p className="text-sm text-muted-foreground mb-6">Full-featured site for established South Coast businesses ready to grow</p>
              <ul className="space-y-2 mb-6">
      ...
      <section className="section-padding bg-background">
        <div className="container-tight max-w-3xl mx-auto">
          <ScrollReveal variant="B" className="text-center mb-10">
            <motion.h2 variants={fadeUpB} className="heading-section text-foreground mb-4">
              Web Design South Coast — Frequently Asked Questions
            </motion.h2>
          </ScrollReveal>
      ...
      <section className="section-padding" style={{ background: "var(--surface-gradient)" }}>
        <div className="container-tight">
          <ScrollReveal variant="B" className="text-center mb-10">
            ...
            <motion.p variants={fadeUpB} className="text-body-lg text-muted-foreground max-w-2xl mx-auto">
              We build websites for businesses across the South Coast, Illawarra, and NSW.
            </motion.p>
          </ScrollReveal>
            ...
            <motion.div variants={fadeUpB}>
              <Link href="/web-design-nowra" className="group flex gap-4 p-6 bg-card rounded-xl border border-border shadow-card card-hover-lift">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Custom web design and local SEO for Nowra businesses in the heart of the Shoalhaven.</p>
            ...
            <motion.div variants={fadeUpB}>
              <Link href="/web-design-wollongong" className="group flex gap-4 p-6 bg-card rounded-xl border border-border shadow-card card-hover-lift">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Professional web design for Wollongong and Illawarra businesses — websites that rank and convert.</p>
                  <span className="text-sm text-accent font-medium mt-2 inline-flex items-center gap-1">Learn more <ArrowRight className="w-3 h-3" /></span>
                </div>
              </Link>
            </motion.div>
            <motion.div variants={fadeUpB}>
              <Link href="/web-design-illawarra" className="group flex gap-4 p-6 bg-card rounded-xl border border-border shadow-card card-hover-lift">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Serving Shellharbour, Dapto, and the wider Illawarra region with local web design & SEO.</p>
                  <span className="text-sm text-accent font-medium mt-2 inline-flex items-center gap-1">Learn more <ArrowRight className="w-3 h-3" /></span>
                </div>
              </Link>
            </motion.div>
        ...
        <div className="container-tight px-4 py-20 text-center relative z-10">
          <ScrollReveal variant="B">
            <motion.h2 variants={fadeUpB} className="heading-section text-primary-foreground mb-4">
              Ready to Grow Your South Coast Business Online?
            </motion.h2>
            <motion.p variants={fadeUpB} className="text-body-lg text-primary-foreground/75 max-w-2xl mx-auto mb-8">
              Get a free, no-obligation quote for your South Coast website. We'll discuss your goals and recommend the best solution for your business.
            </motion.p>
...
export default WebDesignSouthCoast;
