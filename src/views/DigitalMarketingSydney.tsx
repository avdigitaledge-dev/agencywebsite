...
const DigitalMarketingSydney = () => {
  const localBusinessSchema = {
    "@context": "https://schema.org",
    "@type": "LocalBusiness",
    "name": "Digital Edge Studio",
    "description": "Digital marketing agency serving Sydney specialising in SEO, Google Ads, social media, and content marketing for small businesses across all Sydney regions",
    "url": "https://digitaledgestudio.com/digital-marketing-sydney",
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      ...
      {
        "@type": "Question",
        "name": "What digital marketing services do you offer in Sydney?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "We offer a full suite: SEO and local SEO, Google Ads management, social media marketing (Facebook, Instagram, LinkedIn), content marketing, email marketing, and conversion rate optimisation. Every strategy is tailored to your Sydney business goals."
        }
      },
      {
        "@type": "Question",
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "We're based in Wollongong and serve businesses across all of Sydney. You get the personal attention of a boutique agency — not a massive Sydney firm where you're just another account number. We're always available for video calls and can meet in person when needed."
        }
      },
      {
        "@type": "Question",
        "name": "Do you offer Google Ads management in Sydney?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Yes — we manage targeted Google Ads campaigns for Sydney businesses across all industries. We focus on high-intent keywords, optimise for conversions, and provide transparent reporting on every dollar spent."
        }
      },
      {
        "@type": "Question",
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "We provide monthly reports with clear KPIs: organic traffic growth, keyword rankings, leads generated, conversion rates, and ROI. No vanity metrics — we track what matters to your bottom line."
        }
      },
      {
        "@type": "Question",
        "name": "Do you offer social media marketing in Sydney?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Yes — we manage social media marketing across Facebook, Instagram, and LinkedIn for Sydney businesses. This includes content creation, scheduling, community management, and paid social advertising."
        }
      }
    ]
  };
  ...
  const services = [
    { title: "SEO & Local SEO", desc: "Rank higher in Google for Sydney-specific keywords. We optimise your site and Google Business Profile to drive organic traffic and local leads.", link: "/services/seo" },
    ...
    { title: "Content Marketing", desc: "Strategic blog posts, landing pages, and website copy that attract your ideal customers and position your business as an authority in your industry." },
        ...
        <div className="container-tight px-4 py-16 md:py-24 relative z-10">
          ...
          >
            ...
            <motion.p variants={fadeUpB} className="text-body-lg text-primary-foreground/75 max-w-2xl mb-8">
              Grow your Sydney business with integrated digital marketing — SEO, Google Ads, social media, and content strategy. Personal service, transparent pricing, and no lock-in contracts.
            </motion.p>
      ...
      <section className="bg-muted py-8">
        <div className="container-tight px-4">
          <div className="flex flex-wrap justify-center gap-8 text-sm text-muted-foreground">
            {["Sydney Marketing Specialist", "No Lock-In Contracts", "Measurable ROI", "Free Strategy Session", "Data-Driven Campaigns"].map((item) => (
        ...
        <div className="container-tight">
          <ScrollReveal variant="B" className="text-center mb-14">
            ...
            <motion.p variants={fadeUpB} className="text-body-lg text-muted-foreground max-w-2xl mx-auto">
              Everything your Sydney business needs to attract more customers, generate qualified leads, and grow revenue online.
            </motion.p>
          </ScrollReveal>
          ...
          <ScrollReveal variant="B" className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div variants={fadeUpB}>
              <h2 className="heading-section text-foreground mb-6">
                Why Choose Digital Edge Studio for Sydney Digital Marketing?
              </h2>
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                <p>
                  Sydney is Australia's largest and most competitive market. Many businesses waste thousands on agencies that deliver reports full of vanity metrics but no real leads. We do things differently.
                </p>
                <p>
                  At Digital Edge Studio, you deal directly with the person managing your campaigns. No account managers, no runarounds, no "we'll get back to you." We're transparent about what we do, what it costs, and what results you can expect.
                </p>
                <p>
                  We combine the personal service of a boutique agency with the expertise to deliver results in Sydney's most competitive industries — from trades and healthcare to retail and professional services.
                </p>
              </div>
              <div className="mt-8">
                <Button asChild>
            ...
            <motion.div variants={fadeUpB} className="space-y-4">
              {[
                { title: "Sydney Market Knowledge", desc: "We understand Sydney's competitive landscape and what it takes to stand out in Australia's largest market." },
                ...
                { title: "Transparent Reporting", desc: "Monthly reports showing exactly where your budget goes and the results it delivers. No vanity metrics." },
      ...
      <section className="section-padding bg-background">
        <div className="container-tight max-w-3xl mx-auto">
          <ScrollReveal variant="B" className="text-center mb-10">
            <motion.h2 variants={fadeUpB} className="heading-section text-foreground mb-4">
              Digital Marketing Sydney — Frequently Asked Questions
            </motion.h2>
          </ScrollReveal>
      ...
      <section className="section-padding" style={{ background: "var(--surface-gradient)" }}>
        <div className="container-tight">
          <ScrollReveal variant="B" className="text-center mb-10">
            ...
            <motion.p variants={fadeUpB} className="text-body-lg text-muted-foreground max-w-2xl mx-auto">
              Based in Wollongong, we deliver digital marketing services for businesses across NSW.
            </motion.p>
          </ScrollReveal>
        ...
        <div className="container-tight px-4 py-20 text-center relative z-10">
          <ScrollReveal variant="B">
            ...
            <motion.p variants={fadeUpB} className="text-body-lg text-primary-foreground/75 max-w-2xl mx-auto mb-8">
              Book a free strategy session and discover how integrated digital marketing can drive more leads and revenue for your Sydney business.
            </motion.p>
...
export default DigitalMarketingSydney;
