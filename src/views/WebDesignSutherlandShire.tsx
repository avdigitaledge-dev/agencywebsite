...
const WebDesignSutherlandShire = () => {
  const faqSchema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "Do you offer web design in the Sutherland Shire?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Yes — we serve businesses across the entire Sutherland Shire including Cronulla, Miranda, Caringbah, Sutherland, Engadine, Gymea, and Sylvania. We combine Wollongong-based personal service with deep knowledge of the Sydney southern suburbs market."
        }
      },
      {
        "@type": "Question",
        "name": "How much does a website cost for a Shire business?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Our Sutherland Shire web design packages start from $1,200 for a Starter Website and $1,850 for a full Business Website. We offer transparent pricing with no hidden fees or lock-in contracts."
        }
      },
      {
        "@type": "Question",
        "name": "Can you help with local SEO in Sutherland Shire?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Yes — local SEO is one of our specialties. We optimise your Google Business Profile, target Shire-specific search terms, and help you rank higher in local Google Maps results for suburbs like Cronulla, Miranda, and Caringbah."
        }
      },
      {
        "@type": "Question",
        "name": "Are you based in the Shire?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "We're based in Wollongong, which means we bridge personal, hands-on service with the reach and expertise needed to compete in the greater Sydney market. We work closely with Shire businesses both remotely and in person."
        }
      },
      {
        "@type": "Question",
        "name": "Do you work with businesses in Cronulla and Miranda?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Absolutely. We serve businesses in all Sutherland Shire suburbs including Cronulla, Miranda, Caringbah, Sutherland, Engadine, Gymea, Sylvania, and everywhere in between."
        }
      }
    ]
  };
  ...
  const services = [
    { title: "Custom Website Design", desc: "Professionally designed websites built to convert Shire visitors into enquiries — not just look pretty." },
    { title: "Local SEO Sutherland Shire", desc: "Rank higher in Google Maps and organic search for Shire-specific keywords that drive real leads." },
    { title: "Mobile-Optimised Websites", desc: "Over 70% of local searches happen on mobile. Your Sutherland Shire website will look perfect on every device." },
    { title: "Google Ads Management", desc: "Targeted Google Ads campaigns for Shire businesses — only pay when someone clicks to your site." },
    { title: "Ecommerce Web Design", desc: "Online stores built on Shopify or WooCommerce to sell products to the Shire and beyond." },
    { title: "Website Maintenance", desc: "Monthly plans to keep your Sutherland Shire website fast, secure, and up to date. From $99/month." },
  ];
  ...
  return (
    <>
      ...
      <Breadcrumb items={[
        { label: 'Home', path: '/' },
        { label: 'Web Design Sutherland Shire' }
      ]} />
        ...
        <div className="container-tight px-4 py-16 md:py-24 relative z-10">
          ...
          >
            <motion.div variants={fadeUpB} className="flex items-center gap-2 text-primary-foreground/70 text-sm mb-4">
              ...
              <span>Serving Sutherland Shire & Southern Sydney</span>
            </motion.div>
            ...
            <motion.p variants={fadeUpB} className="text-body-lg text-primary-foreground/75 max-w-2xl mb-8">
              Professional web design for Sutherland Shire businesses. We bridge Wollongong personal service with Sydney market reach — building websites that rank on Google, generate leads, and grow your business.
            </motion.p>
      ...
      <section className="bg-muted py-8">
        <div className="container-tight px-4">
          <div className="flex flex-wrap justify-center gap-8 text-sm text-muted-foreground">
            {["Wollongong Personal Service, Sydney Reach", "No Lock-In Contracts", "Fast 4\u20138 Week Turnaround", "Free Quote & Consultation", "Google Business Profile Setup Included"].map((item) => (
        ...
        <div className="container-tight">
          <ScrollReveal variant="B" className="text-center mb-14">
            <motion.h2 variants={fadeUpB} className="heading-section text-foreground mb-4">
              Web Design Services for the Sutherland Shire
            </motion.h2>
            <motion.p variants={fadeUpB} className="text-body-lg text-muted-foreground max-w-2xl mx-auto">
              Everything your Sutherland Shire business needs to get found online and turn website visitors into paying customers.
            </motion.p>
          </ScrollReveal>
          ...
          <ScrollReveal variant="B" className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div variants={fadeUpB}>
              <h2 className="heading-section text-foreground mb-6">
                Why Choose Digital Edge Studio for Your Shire Website?
              </h2>
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                <p>
                  When you choose Digital Edge Studio for your Sutherland Shire website, you get the best of both worlds — the personal, hands-on service of a Wollongong-based agency with the expertise and reach to compete in the greater Sydney market.
                </p>
                <p>
                  We work with businesses across the Shire — from Cronulla and Miranda to Caringbah, Sutherland, Engadine, Gymea, and Sylvania. We understand the local market and what Shire customers search for when they need a business like yours.
                </p>
                <p>
                  Unlike big Sydney agencies, you deal directly with the person building your website — and we're here to support you long after your site goes live.
                </p>
              </div>
              <div className="mt-8">
                <Button asChild>
                  <Link href="/contact">Talk to Us About Your Shire Website <ArrowRight className="w-4 h-4 ml-1" /></Link>
                </Button>
              </div>
            </motion.div>
            <motion.div variants={fadeUpB} className="space-y-4">
              {[
                { title: "Shire Market Knowledge", desc: "We understand the Sutherland Shire business landscape and what local customers search for across Cronulla, Miranda, and beyond." },
                { title: "Local SEO for The Shire", desc: "We optimise specifically for Sutherland Shire search terms and suburbs, not generic Sydney keywords." },
                { title: "Personal Direct Service", desc: "You always deal directly with the person running your project — no account managers or offshore teams." },
                { title: "Long-Term Partnership", desc: "We don't disappear after launch. We're here to grow your Shire business month after month." },
              ].map((item) => (
        ...
        <div className="container-tight">
          <ScrollReveal variant="B" className="grid md:grid-cols-2 gap-8">
            ...
            <motion.div variants={fadeUpB} className="bg-card rounded-xl p-8 border-2 border-accent shadow-card card-hover-lift">
              ...
              <p className="text-sm text-muted-foreground mb-6">Full-featured site for established Shire businesses ready to grow</p>
              <ul className="space-y-2 mb-6">
      ...
      <section className="section-padding bg-background">
        <div className="container-tight max-w-3xl mx-auto">
          <ScrollReveal variant="B" className="text-center mb-10">
            <motion.h2 variants={fadeUpB} className="heading-section text-foreground mb-4">
              Web Design Sutherland Shire — Frequently Asked Questions
            </motion.h2>
          </ScrollReveal>
      ...
      <section className="section-padding" style={{ background: "var(--surface-gradient)" }}>
        <div className="container-tight">
          ...
          <ScrollReveal variant="B" className="grid md:grid-cols-2 gap-6 max-w-3xl mx-auto">
            <motion.div variants={fadeUpB}>
              <Link href="/web-design-cronulla" className="group flex gap-4 p-6 bg-card rounded-xl border border-border shadow-card card-hover-lift">
                <MapPin className="w-5 h-5 text-accent flex-shrink-0 mt-0.5" />
                <div>
                  <h3 className="font-bold text-foreground font-display group-hover:text-accent transition-colors mb-1">Web Design Cronulla</h3>
                  <p className="text-sm text-muted-foreground">Custom websites and local SEO for Cronulla businesses — stand out in Sydney's iconic beachside suburb.</p>
            ...
            <motion.div variants={fadeUpB}>
              <Link href="/web-design-sydney" className="group flex gap-4 p-6 bg-card rounded-xl border border-border shadow-card card-hover-lift">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Reliable web design for businesses across all Sydney regions — CBD, Western Sydney, Sutherland Shire & more.</p>
                  <span className="text-sm text-accent font-medium mt-2 inline-flex items-center gap-1">Learn more <ArrowRight className="w-3 h-3" /></span>
                </div>
              </Link>
            </motion.div>
            <motion.div variants={fadeUpB}>
              <Link href="/web-design-wollongong" className="group flex gap-4 p-6 bg-card rounded-xl border border-border shadow-card card-hover-lift">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Our home base — professional web design and local SEO for Wollongong and the Illawarra region.</p>
                  <span className="text-sm text-accent font-medium mt-2 inline-flex items-center gap-1">Learn more <ArrowRight className="w-3 h-3" /></span>
                </div>
              </Link>
            </motion.div>
        ...
        <div className="container-tight px-4 py-20 text-center relative z-10">
          <ScrollReveal variant="B">
            <motion.h2 variants={fadeUpB} className="heading-section text-primary-foreground mb-4">
              Ready to Grow Your Shire Business Online?
            </motion.h2>
            <motion.p variants={fadeUpB} className="text-body-lg text-primary-foreground/75 max-w-2xl mx-auto mb-8">
              Get a free, no-obligation quote for your Sutherland Shire website. We'll discuss your goals and recommend the best solution for your business.
            </motion.p>
...
export default WebDesignSutherlandShire;
