...
const WebDesignSouthSydney = () => {
  const localBusinessSchema = {
    "@context": "https://schema.org",
    "@type": "LocalBusiness",
    "name": "Digital Edge Studio",
    "description": "Web design agency serving South Sydney specialising in affordable websites and local SEO for small businesses in Hurstville, Kogarah, Rockdale and surrounds",
    "url": "https://digitaledgestudio.com/web-design-south-sydney",
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "Do you serve businesses in South Sydney?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Yes — we serve businesses across South Sydney including Hurstville, Kogarah, Rockdale, Sans Souci, Brighton-Le-Sands, Arncliffe, and Banksia. We build websites and provide local SEO to help South Sydney businesses grow online."
        }
      },
      {
        "@type": "Question",
        "name": "How much does a website cost for a South Sydney business?",
        "acceptedAnswer": {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        "name": "Can you help with local SEO in the St George area?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Yes — we specialise in local SEO for the South Sydney and St George area. We optimise your Google Business Profile, target South Sydney and St George search terms, and help you rank higher in local Google Maps results."
        }
      },
      {
        "@type": "Question",
        "name": "Are you based in South Sydney?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "We're based in Wollongong, which allows us to bridge personal, hands-on service with Sydney market reach. We work closely with South Sydney businesses remotely and in person to deliver websites that drive real results."
        }
      },
      {
        "@type": "Question",
        "name": "Do you offer Google Ads for South Sydney businesses?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Yes — we run targeted PPC campaigns for South Sydney businesses. Our Google Ads management ensures your ads reach the right local customers, maximising your return on investment."
        }
      }
    ]
  };
  ...
  const services = [
    { title: "Custom Website Design", desc: "Professionally designed websites built to convert South Sydney visitors into enquiries — not just look pretty." },
    { title: "Local SEO South Sydney", desc: "Rank higher in Google Maps and organic search for South Sydney and St George keywords that drive real leads." },
    { title: "Mobile-Optimised Websites", desc: "Over 70% of local searches happen on mobile. Your South Sydney website will look perfect on every device." },
    { title: "Google Ads Management", desc: "Targeted Google Ads campaigns for South Sydney businesses — only pay when someone clicks to your site." },
    { title: "Ecommerce Web Design", desc: "Online stores built on Shopify or WooCommerce to sell products to South Sydney and beyond." },
    { title: "Website Maintenance", desc: "Monthly plans to keep your South Sydney website fast, secure, and up to date. From $99/month." },
  ];
        ...
        <div className="container-tight px-4 py-16 md:py-24 relative z-10">
          ...
          >
            <motion.div variants={fadeUpB} className="flex items-center gap-2 text-primary-foreground/70 text-sm mb-4">
              ...
              <span>Serving South Sydney & St George</span>
            </motion.div>
            <motion.h1 variants={fadeUpB} className="heading-display text-primary-foreground mb-4">
              Web Design South Sydney
            </motion.h1>
            <motion.p variants={fadeUpB} className="text-body-lg text-primary-foreground/75 max-w-2xl mb-8">
              Professional web design for South Sydney businesses. We bridge Wollongong's personal, hands-on service with Sydney market reach — covering Hurstville, Kogarah, Rockdale, and surrounds.
            </motion.p>
      ...
      <section className="bg-muted py-8">
        <div className="container-tight px-4">
          <div className="flex flex-wrap justify-center gap-8 text-sm text-muted-foreground">
            {["Wollongong Service, Sydney Reach", "No Lock-In Contracts", "Fast 4-8 Week Turnaround", "Free Quote & Consultation", "Google Business Profile Setup Included"].map((item) => (
        ...
        <div className="container-tight">
          <ScrollReveal variant="B" className="text-center mb-14">
            <motion.h2 variants={fadeUpB} className="heading-section text-foreground mb-4">
              Web Design Services for South Sydney
            </motion.h2>
            <motion.p variants={fadeUpB} className="text-body-lg text-muted-foreground max-w-2xl mx-auto">
              Everything your South Sydney business needs to get found online and turn website visitors into paying customers.
            </motion.p>
          </ScrollReveal>
          ...
          <ScrollReveal variant="B" className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div variants={fadeUpB}>
              <h2 className="heading-section text-foreground mb-6">
                Why Choose Digital Edge Studio for Your South Sydney Website?
              </h2>
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                <p>
                  South Sydney and the St George area is home to a large, diverse multicultural small business community — from Hurstville to Kogarah, Rockdale, Sans Souci, Brighton-Le-Sands, Arncliffe, and Banksia. We understand the unique needs of businesses in this vibrant region.
                </p>
                <p>
                  Based in Wollongong, we bridge personal, hands-on service with Sydney market reach. You get the dedicated attention of a local agency with the skills and experience to compete in one of Australia's most competitive markets.
                </p>
                <p>
                  Unlike large Sydney agencies that treat you like a number, you'll always deal directly with the person building your website — and we'll be there to support you long after your site goes live.
                </p>
              </div>
              <div className="mt-8">
                <Button asChild>
                  <Link href="/contact">Talk to Us About Your South Sydney Project <ArrowRight className="w-4 h-4 ml-1" /></Link>
                </Button>
              </div>
            </motion.div>
            <motion.div variants={fadeUpB} className="space-y-4">
              {[
                { title: "South Sydney Market Knowledge", desc: "We understand the South Sydney and St George business landscape and what local customers search for." },
                { title: "Local SEO for St George Area", desc: "We optimise specifically for South Sydney and St George search terms, not generic keywords." },
                { title: "Personal Direct Service", desc: "You always deal directly with the person running your project — no account managers or middlemen." },
        ...
        <div className="container-tight">
          <ScrollReveal variant="B" className="grid md:grid-cols-2 gap-8">
            ...
            <motion.div variants={fadeUpB} className="bg-card rounded-xl p-8 border-2 border-accent shadow-card card-hover-lift">
              ...
              <p className="text-sm text-muted-foreground mb-6">Full-featured site for established South Sydney businesses ready to grow</p>
              <ul className="space-y-2 mb-6">
      ...
      <section className="section-padding bg-background">
        <div className="container-tight max-w-3xl mx-auto">
          <ScrollReveal variant="B" className="text-center mb-10">
            <motion.h2 variants={fadeUpB} className="heading-section text-foreground mb-4">
              Web Design South Sydney — Frequently Asked Questions
            </motion.h2>
          </ScrollReveal>
      ...
      <section className="section-padding" style={{ background: "var(--surface-gradient)" }}>
        <div className="container-tight">
          <ScrollReveal variant="B" className="text-center mb-10">
            ...
            <motion.p variants={fadeUpB} className="text-body-lg text-muted-foreground max-w-2xl mx-auto">
              Based in Wollongong, we build websites for businesses across Sydney and NSW.
            </motion.p>
          </ScrollReveal>
            ...
            <motion.div variants={fadeUpB}>
              <Link href="/web-design-sutherland-shire" className="group flex gap-4 p-6 bg-card rounded-xl border border-border shadow-card card-hover-lift">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Custom websites and local SEO for businesses across the Sutherland Shire and Cronulla.</p>
                  <span className="text-sm text-accent font-medium mt-2 inline-flex items-center gap-1">Learn more <ArrowRight className="w-3 h-3" /></span>
                </div>
              </Link>
            </motion.div>
            <motion.div variants={fadeUpB}>
              <Link href="/web-design-campbelltown" className="group flex gap-4 p-6 bg-card rounded-xl border border-border shadow-card card-hover-lift">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Professional web design and digital marketing for Campbelltown and Macarthur region businesses.</p>
                  <span className="text-sm text-accent font-medium mt-2 inline-flex items-center gap-1">Learn more <ArrowRight className="w-3 h-3" /></span>
                </div>
              </Link>
            </motion.div>
        ...
        <div className="container-tight px-4 py-20 text-center relative z-10">
          <ScrollReveal variant="B">
            <motion.h2 variants={fadeUpB} className="heading-section text-primary-foreground mb-4">
              Ready to Grow Your South Sydney Business Online?
            </motion.h2>
            <motion.p variants={fadeUpB} className="text-body-lg text-primary-foreground/75 max-w-2xl mx-auto mb-8">
              Get a free, no-obligation quote for your South Sydney website. We'll discuss your goals and recommend the best solution for your business.
            </motion.p>
...
export default WebDesignSouthSydney;
