      ...
      <section className="bg-muted/30 py-8">
        <div className="container-tight max-w-3xl text-center">
          <p className="text-sm text-muted-foreground">
            ...
            <Link href="/web-design-wollongong" className="text-accent hover:underline font-medium">Wollongong web design page</Link>,{" "}
            <Link href="/seo-wollongong" className="text-accent hover:underline font-medium">Wollongong SEO page</Link>, or the{" "}
