        ...
        <div className="container-tight px-4 py-6">
          <ScrollReveal className="flex flex-wrap justify-center gap-8 md:gap-16 text-sm text-muted-foreground">
            {[
              ...
              { icon: Star, text: "5.0-Star Google Rating" },
              ...
              <div className="p-8">
                ...
                <div className="mt-8 pt-8 border-t border-border text-center">
                  ...
                  <Button variant="cta" size="lg" asChild>
                    <Link href="/contact">Get Started with the Growth Bundle <ArrowRight className="w-5 h-5 ml-1" /></Link>
                  </Button>
                </div>
              </div>
            </motion.div>
          ...
          <ScrollReveal>
            ...
            <motion.div variants={fadeUp} className="flex flex-col sm:flex-row justify-center gap-4">
              <Button variant="hero" size="lg" asChild>
                <Link href="/contact">Request a Free Quote <ArrowRight className="w-5 h-5 ml-1" /></Link>
              </Button>
