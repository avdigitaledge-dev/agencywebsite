...
const WebDesignKiama = () => {
  const localBusinessSchema = {
    "@context": "https://schema.org",
    "@type": "LocalBusiness",
    "name": "Digital Edge Studio",
    "description": "Web design agency serving Kiama, specialising in affordable websites and local SEO for tourism, hospitality, and small businesses on the South Coast",
    "url": "https://digitaledgestudio.com/web-design-kiama",
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "Do you build websites for Kiama businesses?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Yes — we're based just 30 minutes north in Wollongong and regularly work with businesses in Kiama, Gerringong, and across the South Coast. We understand the local market and what it takes to stand out online in a coastal community."
        }
      },
      {
        "@type": "Question",
        "name": "How much does a website cost in Kiama?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Our web design packages start from $1,200 for a Starter Website and $1,850 for a full Business Website. We offer transparent pricing with no hidden fees or lock-in contracts — perfect for Kiama small businesses and tourism operators."
        }
      },
      {
        "@type": "Question",
        "name": "Can you help my tourism business in Kiama get found online?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Absolutely. We have experience building websites for tourism and hospitality businesses. We'll optimise your site to rank for searches like 'things to do in Kiama', 'Kiama accommodation', and other high-intent tourism keywords that drive bookings."
        }
      },
      {
        "@type": "Question",
        "name": "Do you offer local SEO for Kiama?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Yes — local SEO is one of our specialties. We optimise your Google Business Profile, target Kiama-specific search terms, and help you rank higher in local Google Maps results so customers in the area find you first."
        }
      },
      {
        "@type": "Question",
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "We're based in Wollongong, just 30 minutes up the coast from Kiama. We understand the South Coast market because we're part of it, and we're always available for a call or video chat to discuss your project."
        }
      }
    ]
  };
  ...
  const services = [
    { title: "Custom Website Design", desc: "Professionally designed websites built to convert visitors into enquiries — tailored to Kiama's coastal market and tourism-driven economy." },
    { title: "Local SEO Kiama", desc: "Rank higher in Google Maps and organic search for Kiama-specific keywords that drive real leads from locals and visitors alike." },
    { title: "Mobile-Optimised Websites", desc: "Over 70% of local searches happen on mobile. Your Kiama website will look perfect on every device — essential for tourists on the go." },
    { title: "Google Ads Management", desc: "Targeted Google Ads campaigns for Kiama businesses — reach tourists and locals searching for your services right now." },
    { title: "Ecommerce Web Design", desc: "Online stores built on Shopify or WooCommerce to sell products to Kiama customers and beyond." },
    { title: "Website Maintenance", desc: "Monthly plans to keep your Kiama website fast, secure, and up to date. From $99/month." },
  ];
        ...
        <div className="container-tight px-4 py-16 md:py-24 relative z-10">
          ...
          >
            <motion.div variants={fadeUpB} className="flex items-center gap-2 text-primary-foreground/70 text-sm mb-4">
              ...
              <span>Serving Kiama & the South Coast</span>
            </motion.div>
            ...
            <motion.p variants={fadeUpB} className="text-body-lg text-primary-foreground/75 max-w-2xl mb-8">
              Professional web design for Kiama businesses. From tourism operators to local trades, we build websites that rank on Google, generate leads, and grow your business — based just 30 minutes away in Wollongong.
            </motion.p>
      ...
      <section className="bg-muted py-8">
        <div className="container-tight px-4">
          <div className="flex flex-wrap justify-center gap-8 text-sm text-muted-foreground">
            {["Based Just 30 Minutes Away", "No Lock-In Contracts", "Fast 4\u20138 Week Turnaround", "Free Quote & Consultation", "Google Business Profile Setup Included"].map((item) => (
        ...
        <div className="container-tight">
          <ScrollReveal variant="B" className="text-center mb-14">
            <motion.h2 variants={fadeUpB} className="heading-section text-foreground mb-4">
              Web Design Services in Kiama
            </motion.h2>
            <motion.p variants={fadeUpB} className="text-body-lg text-muted-foreground max-w-2xl mx-auto">
              Everything your Kiama business needs to get found online and turn website visitors into paying customers.
            </motion.p>
          </ScrollReveal>
          ...
          <ScrollReveal variant="B" className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div variants={fadeUpB}>
              <h2 className="heading-section text-foreground mb-6">
                Why Choose a Nearby Web Designer for Kiama?
              </h2>
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                <p>
                  Kiama is a thriving coastal town with a strong tourism industry and a growing community of local businesses. Whether you're based in Kiama CBD, Gerringong, Jamberoo, or Minnamurra, your website needs to reflect the unique character of the South Coast while attracting both locals and visitors.
                </p>
                <p>
                  As a Wollongong-based web design studio just 30 minutes up the coast, we understand the Kiama market — the seasonal tourism peaks, the loyal local customer base, and the search terms people use when looking for businesses in the area.
                </p>
                <p>
                  Unlike large agencies or offshore developers, you get personal service from someone who knows the region. We're always available for a call, and we'll be here to support your business long after your site goes live.
                </p>
              </div>
              <div className="mt-8">
                <Button asChild>
                  <Link href="/contact">Talk to a Nearby Web Designer <ArrowRight className="w-4 h-4 ml-1" /></Link>
                </Button>
              </div>
            </motion.div>
            <motion.div variants={fadeUpB} className="space-y-4">
              {[
                { title: "Coastal Market Knowledge", desc: "We understand Kiama's tourism-driven economy and what local customers and visitors search for online." },
                { title: "Kiama SEO Expertise", desc: "We optimise specifically for Kiama and South Coast search terms, not generic keywords that won't convert." },
                { title: "Personal Service", desc: "You deal directly with the person building your website — no account managers, no runaround." },
        ...
        <div className="container-tight">
          <ScrollReveal variant="B" className="grid md:grid-cols-2 gap-8">
            <motion.div variants={fadeUpB} className="bg-card rounded-xl p-8 border border-border shadow-card card-hover-lift">
              ...
              <p className="text-sm text-muted-foreground mb-6">Perfect for Kiama small businesses and trades getting started online</p>
            ...
            <motion.div variants={fadeUpB} className="bg-card rounded-xl p-8 border-2 border-accent shadow-card card-hover-lift">
              ...
              <p className="text-sm text-muted-foreground mb-6">Full-featured site for established Kiama businesses ready to grow</p>
              <ul className="space-y-2 mb-6">
      ...
      <section className="section-padding bg-background">
        <div className="container-tight max-w-3xl mx-auto">
          <ScrollReveal variant="B" className="text-center mb-10">
            <motion.h2 variants={fadeUpB} className="heading-section text-foreground mb-4">
              Web Design Kiama — Frequently Asked Questions
            </motion.h2>
          </ScrollReveal>
      ...
      <section className="section-padding" style={{ background: "var(--surface-gradient)" }}>
        <div className="container-tight">
          <ScrollReveal variant="B" className="text-center mb-10">
            ...
            <motion.p variants={fadeUpB} className="text-body-lg text-muted-foreground max-w-2xl mx-auto">
              Based in the Illawarra, we build websites for businesses across the South Coast and NSW.
            </motion.p>
          </ScrollReveal>
            ...
            <motion.div variants={fadeUpB}>
              <Link href="/web-design-shellharbour" className="group flex gap-4 p-6 bg-card rounded-xl border border-border shadow-card card-hover-lift">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Custom websites for Shellharbour businesses — from Shell Cove to Albion Park and across the municipality.</p>
            ...
            <motion.div variants={fadeUpB}>
              <Link href="/web-design-nowra" className="group flex gap-4 p-6 bg-card rounded-xl border border-border shadow-card card-hover-lift">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Affordable web design for Nowra and Shoalhaven businesses — get found online and grow your customer base.</p>
                  <span className="text-sm text-accent font-medium mt-2 inline-flex items-center gap-1">Learn more <ArrowRight className="w-3 h-3" /></span>
                </div>
              </Link>
            </motion.div>
            <motion.div variants={fadeUpB}>
              <Link href="/web-design-wollongong" className="group flex gap-4 p-6 bg-card rounded-xl border border-border shadow-card card-hover-lift">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Our home base — professional web design and local SEO for Wollongong businesses across the Illawarra.</p>
                  <span className="text-sm text-accent font-medium mt-2 inline-flex items-center gap-1">Learn more <ArrowRight className="w-3 h-3" /></span>
                </div>
              </Link>
            </motion.div>
            <motion.div variants={fadeUpB}>
              <Link href="/web-design-illawarra" className="group flex gap-4 p-6 bg-card rounded-xl border border-border shadow-card card-hover-lift">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Serving the entire Illawarra region with local web design & SEO — from Helensburgh to Kiama and beyond.</p>
                  <span className="text-sm text-accent font-medium mt-2 inline-flex items-center gap-1">Learn more <ArrowRight className="w-3 h-3" /></span>
                </div>
              </Link>
            </motion.div>
        ...
        <div className="container-tight px-4 py-20 text-center relative z-10">
          <ScrollReveal variant="B">
            <motion.h2 variants={fadeUpB} className="heading-section text-primary-foreground mb-4">
              Ready to Grow Your Kiama Business Online?
            </motion.h2>
            <motion.p variants={fadeUpB} className="text-body-lg text-primary-foreground/75 max-w-2xl mx-auto mb-8">
              Get a free, no-obligation quote for your Kiama website. We'll discuss your goals and recommend the best solution for your business.
            </motion.p>
