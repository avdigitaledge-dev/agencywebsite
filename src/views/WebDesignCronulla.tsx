...
const WebDesignCronulla = () => {
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "Do you offer web design in Cronulla?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Yes — we serve Cronulla and the wider Sutherland Shire. We build custom, high-performing websites designed to attract local customers and grow your business online."
        }
      },
      {
        "@type": "Question",
        "name": "How much does a website cost for a Cronulla business?",
        "acceptedAnswer": {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        "name": "Can you help my café or restaurant in Cronulla get online?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Yes — we have experience building websites for hospitality businesses including cafés, restaurants, and bars. We'll create a site that showcases your menu, location, and brand, and helps customers find and book with you."
        }
      },
      {
        "@type": "Question",
        "name": "Do you offer local SEO in Cronulla?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Yes — local SEO is one of our specialties. We optimise your Google Business Profile, target Cronulla-specific search terms, and help you rank higher in local Google Maps results so nearby customers can find you."
        }
      }
    ]
  };
  ...
  const services = [
    ...
    { title: "Local SEO Cronulla", desc: "Rank higher in Google Maps and organic search for Cronulla-specific keywords that drive real leads." },
    { title: "Mobile-Optimised Websites", desc: "Over 70% of local searches happen on mobile. Your Cronulla website will look perfect on every device." },
    { title: "Google Ads Management", desc: "Targeted Google Ads campaigns for Cronulla businesses — only pay when someone clicks to your site." },
    { title: "Ecommerce Web Design", desc: "Online stores built on Shopify or WooCommerce to sell products to Cronulla and beyond." },
    { title: "Website Maintenance", desc: "Monthly plans to keep your Cronulla website fast, secure, and up to date. From $99/month." },
  ];
        ...
        <div className="container-tight px-4 py-16 md:py-24 relative z-10">
          ...
          >
            <motion.div variants={fadeUpB} className="flex items-center gap-2 text-primary-foreground/70 text-sm mb-4">
              ...
              <span>Serving Cronulla & the Shire</span>
            </motion.div>
            ...
            <motion.p variants={fadeUpB} className="text-body-lg text-primary-foreground/75 max-w-2xl mb-8">
              Professional, affordable web design for Cronulla's beachside businesses. We build websites that rank on Google, generate leads, and grow your business — without the big-agency price tag.
            </motion.p>
      ...
      <section className="bg-muted py-8">
        <div className="container-tight px-4">
          <div className="flex flex-wrap justify-center gap-8 text-sm text-muted-foreground">
            {["Wollongong Personal Service, Shire Reach", "No Lock-In Contracts", "Fast 4–8 Week Turnaround", "Free Quote & Consultation", "Google Business Profile Setup Included"].map((item) => (
        ...
        <div className="container-tight">
          <ScrollReveal variant="B" className="text-center mb-14">
            <motion.h2 variants={fadeUpB} className="heading-section text-foreground mb-4">
              Web Design Services in Cronulla
            </motion.h2>
            <motion.p variants={fadeUpB} className="text-body-lg text-muted-foreground max-w-2xl mx-auto">
              Everything your Cronulla business needs to get found online and turn website visitors into paying customers.
            </motion.p>
          </ScrollReveal>
          ...
          <ScrollReveal variant="B" className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div variants={fadeUpB}>
              <h2 className="heading-section text-foreground mb-6">
                Why Choose Digital Edge Studio for Your Cronulla Website?
              </h2>
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                <p>
                  Cronulla is one of Sydney's most vibrant beachside suburbs, home to a thriving mix of hospitality, retail, and service businesses along Cronulla Mall, the Kingsway, and North Cronulla. Your website needs to capture that energy and connect you with the local customers searching for what you offer.
                </p>
                <p>
                  We understand the Sutherland Shire market and build websites specifically designed to rank for local searches, attract foot traffic, and convert online visitors into real customers — whether you run a café on the esplanade, a surf shop, or a trades business.
                </p>
                <p>
              ...
              <div className="mt-8">
                <Button asChild>
                  <Link href="/contact">Talk to Us About Your Cronulla Website <ArrowRight className="w-4 h-4 ml-1" /></Link>
                </Button>
              </div>
            </motion.div>
            <motion.div variants={fadeUpB} className="space-y-4">
              {[
                { title: "Beachside Business Knowledge", desc: "We understand Cronulla's unique mix of hospitality, retail, and services — and what local customers search for." },
                { title: "Cronulla SEO Expertise", desc: "We optimise specifically for Cronulla and Sutherland Shire search terms, not generic keywords." },
                { title: "Personal Service", desc: "You always deal directly with the person running your project — no call centres, no runaround." },
        ...
        <div className="container-tight">
          <ScrollReveal variant="B" className="grid md:grid-cols-2 gap-8">
            ...
            <motion.div variants={fadeUpB} className="bg-card rounded-xl p-8 border-2 border-accent shadow-card card-hover-lift">
              ...
              <p className="text-sm text-muted-foreground mb-6">Full-featured site for established Cronulla businesses ready to grow</p>
              <ul className="space-y-2 mb-6">
      ...
      <section className="section-padding bg-background">
        <div className="container-tight max-w-3xl mx-auto">
          <ScrollReveal variant="B" className="text-center mb-10">
            <motion.h2 variants={fadeUpB} className="heading-section text-foreground mb-4">
              Web Design Cronulla — Frequently Asked Questions
            </motion.h2>
          </ScrollReveal>
      ...
      <section className="section-padding" style={{ background: "var(--surface-gradient)" }}>
        <div className="container-tight">
          <ScrollReveal variant="B" className="text-center mb-10">
            ...
            <motion.p variants={fadeUpB} className="text-body-lg text-muted-foreground max-w-2xl mx-auto">
              Based in NSW, we build websites for businesses across the Shire, Sydney, and beyond.
            </motion.p>
          </ScrollReveal>
            ...
            <motion.div variants={fadeUpB}>
              <Link href="/web-design-sutherland-shire" className="group flex gap-4 p-6 bg-card rounded-xl border border-border shadow-card card-hover-lift">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Affordable web design for businesses across the Sutherland Shire — Caringbah, Miranda, Engadine, Menai & more.</p>
            ...
            <motion.div variants={fadeUpB}>
              <Link href="/web-design-sydney" className="group flex gap-4 p-6 bg-card rounded-xl border border-border shadow-card card-hover-lift">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Affordable web design for businesses across all Sydney regions — CBD, Western Sydney, Northern Beaches & more.</p>
                  <span className="text-sm text-accent font-medium mt-2 inline-flex items-center gap-1">Learn more <ArrowRight className="w-3 h-3" /></span>
                </div>
              </Link>
            </motion.div>
            <motion.div variants={fadeUpB}>
              <Link href="/web-design-wollongong" className="group flex gap-4 p-6 bg-card rounded-xl border border-border shadow-card card-hover-lift">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Professional web design for Wollongong and Illawarra businesses — local SEO, Google Ads & custom websites.</p>
                  <span className="text-sm text-accent font-medium mt-2 inline-flex items-center gap-1">Learn more <ArrowRight className="w-3 h-3" /></span>
                </div>
              </Link>
            </motion.div>
        ...
        <div className="container-tight px-4 py-20 text-center relative z-10">
          <ScrollReveal variant="B">
            <motion.h2 variants={fadeUpB} className="heading-section text-primary-foreground mb-4">
              Ready to Grow Your Cronulla Business Online?
            </motion.h2>
            <motion.p variants={fadeUpB} className="text-body-lg text-primary-foreground/75 max-w-2xl mx-auto mb-8">
              Get a free, no-obligation quote for your Cronulla website. We'll discuss your goals and recommend the best solution for your business.
            </motion.p>
...
export default WebDesignCronulla;
