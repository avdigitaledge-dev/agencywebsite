...
const WebDesignThirroul = () => {
  ...
  const webPageSchema = {
    "@context": "https://schema.org",
    "@type": "WebPage",
    "name": "Web Design Thirroul | Local Websites & SEO",
            ...
            <motion.div variants={fadeUpB}>
              <Link href="/web-design-wollongong" className="group flex gap-4 p-6 bg-card rounded-xl border border-border shadow-card card-hover-lift">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Professional web design for Wollongong businesses — reliable websites and local SEO that deliver results.</p>
