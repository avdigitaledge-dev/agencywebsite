...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE_URL}/areas-we-serve`, lastModified: lastUpdated, changeFrequency: "monthly", priority: 0.8 },
    { url: `${BASE_URL}/web-design-shellharbour`, lastModified: lastUpdated, changeFrequency: "monthly", priority: 0.9 },
    { url: `${BASE_URL}/web-design-nowra`, lastModified: lastUpdated, changeFrequency: "monthly", priority: 0.9 },
    { url: `${BASE_URL}/web-design-sutherland-shire`, lastModified: lastUpdated, changeFrequency: "monthly", priority: 0.9 },
    { url: `${BASE_URL}/web-design-kiama`, lastModified: lastUpdated, changeFrequency: "monthly", priority: 0.9 },
    { url: `${BASE_URL}/web-design-south-coast`, lastModified: lastUpdated, changeFrequency: "monthly", priority: 0.9 },
    { url: `${BASE_URL}/web-design-cronulla`, lastModified: lastUpdated, changeFrequency: "monthly", priority: 0.9 },
    { url: `${BASE_URL}/web-design-thirroul`, lastModified: lastUpdated, changeFrequency: "monthly", priority: 0.9 },
    { url: `${BASE_URL}/web-design-south-sydney`, lastModified: lastUpdated, changeFrequency: "monthly", priority: 0.9 },
    { url: `${BASE_URL}/web-design-western-sydney`, lastModified: lastUpdated, changeFrequency: "monthly", priority: 0.9 },
    { url: `${BASE_URL}/marketing-agency-shoalhaven`, lastModified: lastUpdated, changeFrequency: "monthly", priority: 0.9 },
    { url: `${BASE_URL}/seo-sydney`, lastModified: lastUpdated, changeFrequency: "monthly", priority: 0.9 },
    { url: `${BASE_URL}/digital-marketing-sydney`, lastModified: lastUpdated, changeFrequency: "monthly", priority: 0.9 },
    // Industry pages
    { url: `${BASE_URL}/industries`, lastModified: lastUpdated, changeFrequency: "monthly", priority: 0.8 },
    { url: `${BASE_URL}/web-design-tradies`, lastModified: lastUpdated, changeFrequency: "monthly", priority: 0.8 },
    { url: `${BASE_URL}/web-design-restaurants`, lastModified: lastUpdated, changeFrequency: "monthly", priority: 0.8 },
    { url: `${BASE_URL}/web-design-healthcare`, lastModified: lastUpdated, changeFrequency: "monthly", priority: 0.8 },
    { url: `${BASE_URL}/web-design-accountants`, lastModified: lastUpdated, changeFrequency: "monthly", priority: 0.8 },
    { url: `${BASE_URL}/web-design-real-estate`, lastModified: lastUpdated, changeFrequency: "monthly", priority: 0.8 },
    { url: `${BASE_URL}/web-design-lawyers`, lastModified: lastUpdated, changeFrequency: "monthly", priority: 0.8 },
    { url: `${BASE_URL}/web-design-dentists`, lastModified: lastUpdated, changeFrequency: "monthly", priority: 0.8 },
    { url: `${BASE_URL}/web-design-ndis`, lastModified: lastUpdated, changeFrequency: "monthly", priority: 0.8 },
    { url: `${BASE_URL}/web-design-gyms`, lastModified: lastUpdated, changeFrequency: "monthly", priority: 0.8 },
